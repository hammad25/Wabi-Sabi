# Generated by Django 3.2.15 on 2022-09-30 15:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('query_type', models.IntegerField(choices=[(0, 'Question'), (1, 'Contribute')], default=0)),
                ('email', models.EmailField(max_length=254)),
                ('message', models.TextField(default='Type your message her', max_length=500)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
